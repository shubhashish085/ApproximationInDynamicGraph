#ifndef ADG_DIST_PES_WORKER
#define ADG_DIST_PES_WORKER
...
class PESComputingNode {

public:

    VertexID maxVertexId;

    std::unordered_multimap<std::pair<VertexID, VertexID>, std::pair<VertexID, ui>, pair_hash> wedge_pool;
    ...
    std::unordered_map<VertexID, float> nodeToMotifs;
    double globalCnt = 0;
    ...
    PESComputingNode(ui memory_budget, double sample_probability, ui pool_size){
    ...
    void processEdgeForPesInCocos(Edge &iEdge);
