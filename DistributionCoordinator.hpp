#ifndef ADG_DIST_COORDINATOR
#define ADG_DIST_COORDINATOR
...
public:
	...
	// Receiving data
	bool sendCnt(double gCnt, std::unordered_map<VertexID, float> &lCnt);
    bool recvCnt(VertexID maxVId, double &gCnt, std::vector<float> &lCnt);
